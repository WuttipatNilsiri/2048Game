...
public class Tile {
	...
	public void drawImage() {
		...
		int drawY = HEIGHT/2 + DrawUtil.getMessageHeight("" + value , font, g)/2;
	...
	public void update() {
		if (begin) {
			...
			Graphics2D g2d = (Graphics2D) beginImage.getGraphics();
	...
	public void render(Graphics2D g) {
		if (begin) g.drawImage(beginImage, x, y, null);
		else if (combineAnimation) g.drawImage(combineImage, (int)(x + WIDTH/2 - scaleCombine*WIDTH/2), 
